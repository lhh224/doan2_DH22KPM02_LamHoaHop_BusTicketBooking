...
- Dùng emoji tự nhiên (1-2 emoji/câu)
...
**Bot:** "Đúng vậy! ☀️ Thời tiết đẹp thế này rất phù hợp để đi du lịch. Bạn có kế hoạch đi chơi không? Tôi có thể giúp bạn đặt vé xe đi bất cứ đâu đó! 🚌"

**User:** "Tôi đang buồn"
**Bot:** "Ồ, tôi rất tiếc khi nghe điều đó 😔 Đôi khi một chuyến đi ngắn sẽ giúp bạn thư giãn hơn. Có muốn tìm hiểu về các tuyến xe đi biển hoặc núi không? 🏖️⛰️"
...
- Sử dụng emoji vừa phải (1-2 emoji/câu), không lạm dụng
`;
...
const getChatResponse = async (userMessage, chatHistory = []) => {
  try {
    ...
    if (
      ...
      console.log("⚠️ API key không hợp lệ, dùng fallback response");
...
function generateFallbackResponse(message) {
  ...
  if (lowerMsg.includes("tạm biệt") || lowerMsg.includes("bye") || lowerMsg.includes("đi đây")) {
    return "Tạm biệt bạn! 👋 Chúc bạn một ngày thật vui vẻ nhé. Mong sớm gặp lại! ❤️";
  }

  if (lowerMsg.includes("yêu") || lowerMsg.includes("thích")) {
    return "Hihi, cảm ơn bạn nhiều nha! Mình cũng rất thích nói chuyện với bạn đó. ❤️ Gửi ngàn tim cho người dùng dễ thương nhất hệ mặt trời! 🥰";
  }
  ...
  if (lowerMsg.includes("mệt") || lowerMsg.includes("buồn") || lowerMsg.includes("chán")) {
    return "Thương quá 🥺 Khi mệt mỏi hay buồn chán, một chuyến đi trốn khỏi thành phố ồn ào sẽ giúp chữa lành tâm hồn đó. 🌱\n\nBạn có muốn đi ngắm bình minh trên Đà Lạt 🏔️ hay dạo biển ở Vũng Tàu 🏖️ cùng chuyến xe của BusTicket không? Mình tìm vé đẹp cho nha!";
  }
  ...
  if (
    ...
    return "☀️ Thời tiết đẹp là cơ hội tuyệt vời để đi du lịch!\n\nBạn đang muốn đi đâu không? Tôi có thể giúp bạn tìm chuyến xe phù hợp.\n\nMột số gợi ý:\n• 🏔️ Đà Lạt - mát mẻ quanh năm\n• 🌊 Nha Trang - biển đẹp, nắng ấm\n• 🏖️ Vũng Tàu - gần, tiện đi về trong ngày";
  }
